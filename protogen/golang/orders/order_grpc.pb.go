...
type OrdersClient interface {
	...
	UpdateOrder(ctx context.Context, in *PayloadWithSingleOrder, opts ...grpc.CallOption) (*Order, error)
...
func (c *ordersClient) UpdateOrder(ctx context.Context, in *PayloadWithSingleOrder, opts ...grpc.CallOption) (*Order, error) {
	out := new(Order)
...
type OrdersServer interface {
	...
	UpdateOrder(context.Context, *PayloadWithSingleOrder) (*Order, error)
...
func (UnimplementedOrdersServer) UpdateOrder(context.Context, *PayloadWithSingleOrder) (*Order, error) {
